    ...
    return (
        <div>
            ...
            <div className="mt-10 text-center">
                <Link to="/all-stories" className="text-xl bg-green-500 px-10 font-bold text-white hover:bg-transparent hover:text-green-500 hover:border-green-500 border transition delay-75 py-2 rounded-lg">All Stories</Link>
                </div>
        </div>
    );
};
