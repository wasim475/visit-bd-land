            ...
            if (result.isConfirmed) {
              fetch(`https://visit-bd-land-server.vercel.app/wishlist/${_id}`, {
                ...
                .then((data) => {
                  ...
                  const remainingData = myWishlists.filter((myfood) => myfood._id !== id)
                ...
                {/* <table className="table"> */}
                    ...
                    {/* row 1 */}
                        <tr>
                            ...
                            <td><br/></td>
                            <th>
                                <Link to={`/packages/${id}`} className="btn bg-green-400 text-white btn-xs">Visit Details</Link>
                                <Link onClick={()=>handleDelete(_id)} className="btn bg-red-600 text-white btn-xs">Delete</Link>
                            </th>
                        </tr>
                    </tbody>  
                {/* </table> */}
